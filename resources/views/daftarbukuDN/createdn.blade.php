@include('inc.header')
   ...
   <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Forms Buku Dalam Negeri</h1>
                </div>
                 <form action="{{url('bukudn')}}" method="post" name="form1" enctype="multipart/form-data">
                 @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" min="0" step="1" data-bind="value:replyNumber" placeholder="masukan tahun keluar buku " name="tahunTerbit">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="replyNumber" min="0" step="1" data-bind="value:replyNumber" placeholder="masukan jumlah buku yang akan disimpan" name="jumlahBuku" >
                    </div>
                    <div class="form-group">
